...
const ZoneSensor = () => {
  ...
  const sensorData = useAppSelector(PolyhouseSelectors.SelectSensorZoneData);
  ...
  const loading = useAppSelector((state) =>
    requestingSelector(state, [PolyhouseActions.REQUEST_SENSOR_DATA_FOR_ZONE])
  );

  const requestData = () => {
    dispatch(PolyhouseActions.requestZoneSensorData(selectedZone.zoneId));
  };
