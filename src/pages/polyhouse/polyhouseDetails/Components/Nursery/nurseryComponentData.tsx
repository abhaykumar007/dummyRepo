...
const NurseryComponent = () => {
  ...
  const sensorData = useAppSelector(
  ...
  const requestData = () => {
    dispatch(
      PolyhouseActions.requestNurseryComponentData(selectedNursery.nurseryId)
    );
  };
...
export default NurseryComponent;
